        ...
        function obj = Chrom(vrp)
            ...
            for i = 1:cCar - 1  % 循环cCar-1次就插入这么多次分隔符0
                ...
                while true
                    ...
                    if (allTime + obj.dis(last, 1)*2) > obj.carInfo(i).timeLimit
                        break;
                    end
        ...
        function obj = update(obj)
            ...
            for i = 1 : length(obj.gene)
                ...
                if obj.gene(i) == 0
                    ...
                    obj.time(iCar) = obj.time(iCar) + obj.dis(last, 1) * 2;
                    ...
                    obj.money(iCar) = obj.money(iCar) + 2 * obj.dis(last, 1);
                ...
                % 没遇到分隔符
                    ...
                    % 当前快递员耗时
                    obj.time(iCar) = obj.time(iCar) + obj.dis(last, obj.gene(i)+1)*3 + 10;
                    ...
                    obj.money(iCar) = obj.money(iCar) + 3 * obj.mileage(iCar) * obj.nodeInfo(obj.gene(i)+1).demand;
